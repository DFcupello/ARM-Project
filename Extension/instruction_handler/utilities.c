...
/*
Checks if string is a number in hexadecimal format.
*/
...
/*
Checks if string is empty, either by being newline or whitespace
*/
...
/*
Tokenises the following string, separating it by just newline and spaces
*/
...
/*
Frees tokens generated by the command tokeniser
*/
